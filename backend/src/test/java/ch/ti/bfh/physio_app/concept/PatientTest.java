...
public class PatientTest {
    ...
    public void getTherapeut() throws Exception {
        Therapeut therapeut = new Therapeut("Peter","Pan", "email@email.ch","12345");
        Patient patient = new Patient("John","Doe", "email@email", therapeut);
    ...
    public void setTherapeut() throws Exception {
        Therapeut therapeut = new Therapeut("Peter", "Pan", "email@email.ch", "12345");
        Therapeut therapeut1 = new Therapeut("Elon", "Musk", "email@email.ch", "hackalbe");
        Patient patient = new Patient("John", "Doe", "email@email",  therapeut);
        assertEquals(patient.getTherapeut(), therapeut);
    ...
    public void getSurname(){
        ...
        Patient patient = new Patient("Doe","John", "email@email",   therapeut);
